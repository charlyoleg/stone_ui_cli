...
MY_URL="http://localhost:8000/wall_thermal_conductivity?thickness=0.4&conductivity=3.1"
echo -e "3rd curl requests:\ncurl -X GET '${MY_URL}'"
curl -X GET "${MY_URL}"
echo -e "\n"

MY_URL="http://localhost:8000/wall_thermal_conductivity?thickness=0.2&conductivity=3.1"
echo -e "4th curl requests:\ncurl -X GET '${MY_URL}'"
curl -X GET "${MY_URL}"
echo -e "\n"

MY_URL="http://localhost:8000/call_activities"
